...
export default function AlunoList() {
    ...
    //Se a resposta for positiva, procedemos á exclusão do item 
    ...
    async function deleteItem(){
      ...
      //Aqui vai mensagem de feedback dizendo que deu erro
      // Fechar a caixa de diálogo e exibe a barra de alerta
      setState({
        ...state,
        isDialogOpen:false,
