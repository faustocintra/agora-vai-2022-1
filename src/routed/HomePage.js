/*
    ...
    3. Altere o arquivo "Apps.js" e adicione um novo Route, com o valor path="/". Assegure-se de que esse novo Route seja POSICIONADO ANTES de todos os outros. Faça com que o componente 
        HomePage seja carregado pelo novo Route. Dessa forma, o componente será exibido assim que a aplicação for aberta no navegador. 
    ...
    9. Ao clicar no botão criado no passo 5, a variável "visible" deve inverter seu valor (ou seja, de true para false ou de false para true). A imagem deve alternar entre visível 
        em invisível.
*/
    ...
    return (
        <>
            ...
            <div className={classes.centralizado}>
                ...
                <p>
                    <Button color='secondary' onClick={() => setVisible(!visible)}>Surpresa!</Button>
                </p>
            </div>
        </>
    )
